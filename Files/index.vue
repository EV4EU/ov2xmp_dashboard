                          ...
                          <form class="space-y-5" @submit.prevent="submitLocation_inputs()">
                              <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                                  <div>
                                    ...
                                    <select v-model="Location_inputs.timeZone" id="timeZone" class="form-select w-7/8 mr-4">
                                  ...
                                  <div>
                                      ...
                                      <input id="latitude" type="number" placeholder="Enter Latitude" v-model="Location_inputs.latitude" class="form-input"  step="any"/><!-- required -->
                                  </div>
                                  <div>
                                      <label for="longitude">Longitude</label>
                                      <input id="longitude" type="number" placeholder="Enter Longitude" v-model="Location_inputs.longitude" class="form-input"  step="any"/><!-- required -->
                                  </div>
                                  <div>
